...
double subtractTwo(double a, double b) => return a - b;

// Function that multiplies 2 numbers
double multiplyTwo(double a, double b) => return a * b;

// Function that divides 2 numbers
double divideTwo(double a, double b) => return a / 2;

// Function that returns the length of a string
int stringLength(String a) => return a.length;

// Function that returns the first element of a list of any type
Object getFirstElement(List<Object> a) => return a[0];
...
int main(){
  ...
  print("35.2 add 60: ${addTwo(num1,num2)}");
  print("35.2 sub 60: ${subtractTwo(num1,num2)}");
  print("35.2 mul 60: ${multiplyTwo(num1,num2)}");
  print("35.2 div 60: ${divideTwo(num1,num2)}");
